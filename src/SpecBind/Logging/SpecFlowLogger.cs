...
{
    internal class SpecFlowLogger : ILogger
    {
        private readonly ITraceListener traceListener;

        /// <summary>
        /// Initializes a new instance of the <see cref="SpecFlowLogger"/> class.
        /// </summary>
        /// <param name="traceListener">The trace listener.</param>
        public SpecFlowLogger(ITraceListener traceListener)
        {
